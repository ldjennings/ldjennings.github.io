...
{% include figure.html image="/assets/images/projects/quadrotor/quadrotor_problem.png" caption="Problem Setup" position="right" width="300" height="800" %}
...
{% include figure.html image="/assets/images/projects/quadrotor/quadrotor_FinalResult.png" caption="Quadrotor (green) intercepting a UAV (blue)" position="center" width="600" height="600" %}
