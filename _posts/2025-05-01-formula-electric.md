...
{% include figure.html image="/assets/images/formula_car.jpg" caption="WPI Formula Electric 2025 Vehicle" position="center" width="600" %}
...
{% include figure.html image="/assets/images/formula_inverter_pcb.png" caption="Inverter Controller PCB Rev 1" position="center" width="400" %}
...
{% include figure.html image="/assets/images/formula_radio_pcb.png" caption="Driver Radio Board Rev 2" position="center" width="400" %}
...
{% include figure.html image="/assets/images/formula_pedalbox.png" caption="Assembled Pedalbox" position="center" width="400" %}
